...
def test_default_column_width_uses_domain_specific_defaults() -> None:
    ...
    assert analyse_treewidths.default_column_width("Kontonavn") == 240
    assert analyse_treewidths.default_column_width("Beløp") == 115
    assert analyse_treewidths.default_column_width("Bilag") == 90
