...
import saldobalanse_payload as _saldobalanse_payload
...
def ensure_payroll_context_loaded(page) -> tuple[Any, Any, Any]:
    ...
    if page._profile_document is None and client:
        page._profile_document, page._history_document, page._profile_catalog = _saldobalanse_payload._load_payroll_context(client, year)
...
def ensure_payroll_usage_features_loaded(page) -> dict[str, Any]:
    ...
    if page._payroll_usage_cache_key != cache_key:
        page._payroll_usage_features_cache = _saldobalanse_payload._resolve_payroll_usage_features(analyse_page)
