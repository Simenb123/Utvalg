...
from a07_feature import page_a07_control_statement as _control_statement
...
from a07_feature import page_a07_render as _render
from a07_feature import page_a07_rf1022 as _rf1022
from a07_feature import page_a07_selection as _selection
from a07_feature import page_a07_support_render as _support_render
from a07_feature import page_a07_tree_render as _tree_render
from a07_feature import page_a07_ui as _ui
from a07_feature import page_a07_ui_canonical as _ui_canonical
from a07_feature import page_a07_ui_helpers as _ui_helpers
...
_WRAP_NAMES = [
    name for name in (
        'A07Group', 'AccountProfileLegacyApi', 'AccountUsageFeatures', 'A07WorkspaceData', 'SuggestConfig',
        'EXCLUDED_A07_CODES', 'build_a07_overview_df', 'build_control_accounts_summary', 'build_control_gl_df',
        'build_control_queue_df', 'build_control_selected_account_df', 'build_control_statement_accounts_df',
        'build_control_statement_export_df', 'build_control_statement_overview', 'build_control_statement_summary',
        'build_control_bucket_summary', 'build_control_suggestion_effect_summary', 'build_control_suggestion_summary',
        'build_default_group_name', 'build_gl_picker_options', 'build_a07_picker_options', 'build_history_comparison_df', 'build_mapping_history_details',
        'build_rf1022_accounts_df', 'build_rf1022_statement_df', 'build_rf1022_statement_summary',
        'build_source_overview_rows', 'build_suggest_config', 'build_rule_payload', 'compact_control_next_action', 'control_action_style',
        'control_gl_tree_tag', 'control_intro_text', 'control_next_action_label', 'control_queue_tree_tag',
        'control_recommendation_label', 'control_tree_tag', 'count_pending_control_items', 'count_unsolved_a07_codes',
        'copy_a07_source_to_workspace', 'copy_rulebook_to_storage', 'decorate_suggestions_for_display',
        'default_a07_export_path', 'default_a07_groups_path', 'default_a07_locks_path', 'default_a07_project_path',
        'default_a07_source_path', 'bundled_default_rulebook_path', 'filter_a07_overview_df', 'filter_control_gl_df', 'filter_control_queue_df',
        'filter_control_visible_codes_df', 'filter_suggestions_df', 'find_previous_year_context',
        'find_previous_year_mapping_path', 'get_a07_workspace_dir', 'get_active_trial_balance_path_for_context',
        'get_context_snapshot', 'legacy_global_a07_mapping_path', 'legacy_global_a07_source_path',
        'load_active_trial_balance_for_context', 'load_a07_groups', 'load_locks', 'load_matcher_settings', 'load_previous_year_mapping_for_context',
        'normalize_matcher_settings', 'open_manual_mapping_dialog', 'parse_a07_json', 'reconcile_tree_tag',
        'remove_mapping_accounts', 'resolve_autosave_mapping_path', 'resolve_context_mapping_path',
        'resolve_context_source_path', 'resolve_rulebook_path', 'rf1022_post_for_group', 'safe_previous_accounts_for_code',
        'select_batch_suggestion_rows', 'select_magic_wand_suggestion_rows', 'select_safe_history_codes',
        'suggest_default_mapping_path', 'suggestion_tree_tag', 'ui_suggestion_row_from_series', 'unresolved_codes',
        'best_suggestion_row_for_code', 'a07_suggestion_is_strict_auto', '_build_usage_features_for_a07',
        '_empty_a07_df', '_empty_control_df', '_empty_gl_df', '_empty_groups_df', '_empty_history_df',
        '_empty_mapping_df', '_empty_reconcile_df', '_empty_rf1022_accounts_df', '_empty_rf1022_overview_df',
        '_empty_suggestions_df', '_empty_unmapped_df', '_empty_control_statement_df', '_empty_selected_accounts_df',
        '_format_aliases_editor', '_parse_aliases_editor', '_format_picker_amount', '_load_code_profile_state', '_account_profile_api_for_a07',
        'apply_manual_mapping_choice', 'apply_manual_mapping_choices',
...
class A07Page(A07PageMethodsMixin, ttk.Frame):
    def __init__(self, parent: tk.Misc, *args, **kwargs) -> None:
        ...
        self._rf1022_window: tk.Toplevel | None = None
        ...
        self.suggestion_details_var = tk.StringVar(value="Velg et forslag for aa se hvorfor det passer og hva som blir koblet.")
        self.control_suggestion_summary_var = tk.StringVar(value="Velg A07-kode til hoyre for aa se beste forslag.")
        self.control_suggestion_effect_var = tk.StringVar(value="Velg et forslag for aa se hva som blir koblet.")
        self.history_details_var = tk.StringVar(value="Velg en kode for aa se historikk.")
        self.control_summary_var = tk.StringVar(value="Velg A07-kode til hoyre.")
        ...
        self.control_accounts_summary_var = tk.StringVar(value="Velg A07-kode til hoyre for aa se hva som er koblet na.")
        ...
        self.control_statement_accounts_summary_var = tk.StringVar(
            value="Velg gruppe i kontrolloppstillingen for aa se kontoene bak raden."
        )
        self.control_drag_var = tk.StringVar(value=_CONTROL_DRAG_IDLE_HINT)
        self.control_bucket_var = tk.StringVar(value="UlÃ¸ste 0 | Forslag 0 | Historikk 0 | Manuell 0 | Ferdig 0")
        ...
        self.control_alternative_summary_var = tk.StringVar(value="Velg A07-kode til hoyre for aa se alternativer.")
...
__all__ = ['A07Page'] + _WRAP_NAMES + ['app_paths', 'client_store', 'session', 'filedialog', 'messagebox', 'simpledialog']
